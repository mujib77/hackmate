  ...
  return (
    <div className="min-h-screen bg-[#0a0a0c] text-white font-sans selection:bg-purple-500/30 relative overflow-hidden flex flex-col">
      ...
      <div className="max-w-2xl mx-auto w-full px-6 py-12 relative z-10">
        ...
        <div className="bg-white/[0.03] border border-white/10 rounded-[32px] backdrop-blur-xl p-8 md:p-10 mb-8 shadow-2xl relative overflow-hidden">
        ...
        {editing ? (
          <div className="bg-white/[0.05] border border-purple-500/20 rounded-[32px] backdrop-blur-2xl p-8 shadow-2xl">
